	...
	routes := group("api",
		...
		use(authMiddleware,
			...
			group("session",
				...
				get("blacklist", msgApi.GetBlackList),
				get("whitelist", msgApi.GetWhiteList),
				post("whitelist/add", msgApi.AddToWhiteList),
				post("whitelist/remove", msgApi.RemoveFromWhiteList),
				post("blacklist/add", msgApi.AddToBlackList),
				post("blacklist/remove", msgApi.RemoveFromBlackList),
				post("blacklist/update", msgApi.UpdateBlackList),
			),
			group("message",
